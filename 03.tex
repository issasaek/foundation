...
ところで，真理集合$ \mathrm{T}^{(\breve{\epsilon}\fap \Lambda)}\cap \mathfrak{L} $には，\ref{ssec:集合論の体系}のA \ref{axim:外延性}〜A \ref{axim:分出}が含まれる．これらの公理の集合を$a$と置く．また，解釈空間の定義上，任意の$h\in\arg\epsilon$について，
\[
