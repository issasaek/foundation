...
$}は\kagi{$
    ...
    \indx{\epsilon} \neq\Lambda\con{1}
    (\barl{\classab{\indx{\epsilon}}}\uphl\mathfrak{E})\img(\epsilon\img\univ)\subseteq \epsilon\img\univ\subseteq\mathbb{N}
$}を表わす．
\end{df}
...
\begin{enumerate}[label=(\arabic*)]
    ...
    \item \kagi{$(\alpha$は人間である)}の\kagi{$\alpha$}に任意の変項を代入した結果は，\kagi{$ (F,)\alpha $}に同一の代入をした結果を表わす，
