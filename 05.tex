...
\begin{align*}
    d = \mathcal{P}(\trgl{\arg\epsilon}\cap\classab{\orp{x,y}:x\in\enf{\epsilon}y})
\end{align*}
...
\[
    e\subseteq \mathrm{SY}^{\epsilon}\alpha\cup \varSigma^{\epsilon}\alpha\con{1}d = \mathcal{P}(\trgl{\arg\epsilon}\cap\classab{\orp{x,y}:x\in\enf{\epsilon}y})
\]
