...
$}は，\\\hfill
\kagi{$
    \mathrm{Ho}^{\epsilon}\cap\classab{v:
        \tildel{\trgl{v}}\fap 0 = \classab{\orp{\orp{z,y},i}:
            (\exists h)[z\in\prob{\mathcal{P}(h\cap\enf{\epsilon}y)}{i\uphl\epsilon}]
        }\cap\mser{(\arg v)}{0}
    }
$}を表わす，
\end{df}
...
\kagi{$
    \mathrm{Ho}^{\epsilon}\cap\classab{v:
        \tildel{\trgl{v}}\fap 0 = \classab{\orp{\orp{z,y},i}:
            (\exists h)[z\in\prob{\mathcal{P}(h\cap\barl{(\enf{\epsilon}y)})}{i\uphl\epsilon}]
        }\cap\mser{(\arg v)}{0}
    }
$}を表わす．
\end{df}
